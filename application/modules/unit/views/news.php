                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    foreach ($news->result() as
                                        ...
                                        $set_publish_url = ADMIN_BASE_URL . 'program/set_publish/' . $new->id;

                                        $set_unpublish_url = ADMIN_BASE_URL . 'program/set_unpublish/' . $new->id ;

                                        $edit_url = ADMIN_BASE_URL . 'program/create/' . $new->id ;

                                        $delete_url = ADMIN_BASE_URL . 'program/delete/' . $new->id;
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit program'));



                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete program'));
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              ...
              $.ajax({
                        ...
                        url: "<?php ADMIN_BASE_URL?>program/detail",
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                title : "Are you sure to delete the selected program?",
                ...
                function () {
                       ...
                       $.ajax({
                            ...
                            url: "<?php echo ADMIN_BASE_URL?>program/delete",
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             ...
             $.ajax({
                ...
                url: "<?= ADMIN_BASE_URL ?>program/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php ADMIN_BASE_URL?>program/manage');
