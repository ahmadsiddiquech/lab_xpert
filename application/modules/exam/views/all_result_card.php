...
<?php foreach ($student as $key => $value1) {
$i = 0 ?>
<div class="container mt-2 img-opacity">
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      <?php if (isset($value1['image']) && !empty($value1['image'])) { ?>
        <img src="<?php echo BASE_URL.MEDIUM_STUDENT_IMAGE_PATH.$value1['image']; ?>" height="120px;">
      <?php } else { ?>
  ...
  <div class="row mt-5">
    <div class="col-md-4">
      <h5>Registration No: <span class="s-span"> <?=$value1['id']; ?></span></h5>
    </div>
    <div class="col-md-4">
  ...
  <div class="row mt-2">
    <div class="col-md-6">
      <h5>Student Name: <span class="m-span"> <?=$value1['name']; ?></span></h5>
    </div>
    <div class="col-md-6" style="text-align: right">
      <h5>S/O D/O: <span class="m-span"> <?=$value1['parent_name']; ?></span></h5>
    </div>
  </div>
  <div class="row mt-2">
    <div class="col-md-4">
