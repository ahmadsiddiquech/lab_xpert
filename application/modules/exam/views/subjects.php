...
<div class="content-wrapper">
    ...
    ?>
    <a href="<?php echo ADMIN_BASE_URL . 'exam'; ?>"><button type="button" class="btn btn-lg btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($subject_list)) {
                                    foreach ($subject_list as $key=>
                                        ...
                                        $print_url = ADMIN_BASE_URL . 'exam/print_subject_result/' . $this->uri->segment('4') . '/'. $new['subject_id'] ;
                                        ?>
                                        ...
                                        <?php
                                        echo anchor($marks_url, '<i class="fa fa-mail-forward"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit Exam Marks'));
                                        echo anchor($edit_url, '<i class="fa fa-pencil-square-o"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit Exam Subject'));
                                        echo anchor($print_url, '<i class="fa fa-print"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Print Result'));
                                        ?>
                                    </tr>
                                    <?php } ?>    
                                <?php } ?>
