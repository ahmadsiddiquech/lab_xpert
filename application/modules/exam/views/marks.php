                        ...
                        <tbody>
                                ...
                                if (isset($student_list)) {
                                    foreach ($student_list as $key=>
                                        ...
                                        $i++;
                                        $flag++;
                                        $print_url = ADMIN_BASE_URL . 'exam/print_result_card/' . $this->uri->segment('4') . '/'. $new['std_id'] ;
                                        ...
                                        <td><input class="form-control" readonly type="number" value="<?php echo $new['total_marks']  ?>"></td>
                                         ...
                                         <td><?php echo anchor($print_url, '<i class="fa fa-print"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Print Result')); ?></td>
                                    </tr>
                                    <?php } ?>    
                                <?php } ?>
                            </tbody>
